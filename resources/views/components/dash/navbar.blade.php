      ...
      <div class="navbar-logo">
        ...
        <a class="navbar-brand me-1 me-sm-3" href="{{asset('backend')}}/index.html">
          <div class="d-flex align-items-center">
            <div class="d-flex align-items-center"><img src="{{asset
            ('backend')}}/assets/img/icons/logo.png"
      ...
      <ul class="navbar-nav navbar-nav-icons flex-row">
        ...
        <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
            <div class="avatar avatar-l ">
              <img class="rounded-circle " src="{{asset('backend')}}/assets/img/team/40x40/57.webp" alt="" />
            </div>
          </a>
              ...
              <div class="card-body p-0">
                <div class="text-center pt-4 pb-3">
                  <div class="avatar avatar-xl ">
                    <img class="rounded-circle " src="{{asset('backend')}}/assets/img/team/72x72/57.webp" alt="" />
