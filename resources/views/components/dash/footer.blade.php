            ...
            <div class="row gx-2">
                <div class="col-4">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherLight"> <span
                            class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{ asset ('backend')}}assets/img/generic/default-light.png" alt="" /></span><span
                ...
                <div class="col-4">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherDark"> <span
                            class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{ asset ('backend')}}assets/img/generic/default-dark.png" alt="" /></span><span
                ...
                <div class="col-4">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-9" for="themeSwitcherAuto"> <span
                            class="mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                src="{{ asset ('backend')}}assets/img/generic/auto.png" alt="" /></span><span class="label-text">
                            Auto</span></label>
                </div>
            </div>
        </div>
            ...
            <div class="row gx-2">
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionHorizontal"> <span
                            class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                ...
                                class="img-fluid img-prototype d-light-none"
                                src="{{ asset ('backend')}}assets/img/generic/top-default-dark.png" alt="" /></span><span
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionCombo"> <span
                            class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                src="{{ asset ('backend')}}assets/img/generic/nav-combo-light.png" alt="" /><img
                                class="img-fluid img-prototype d-light-none"
                                src="{{ asset ('backend')}}assets/img/generic/nav-combo-dark.png" alt="" /></span><span
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarPositionTopDouble"> <span
                            class="rounded d-block"><img class="img-fluid img-prototype d-dark-none"
                                ...
                                class="img-fluid img-prototype d-light-none" src="{{ asset ('backend')}}assets/img/generic/dual-dark.png"
            ...
            <div class="row gx-2">
                <div class="col-6">
                    ...
                    <label class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-default"> <img
                            class="img-fluid img-prototype d-dark-none" src="{{ asset ('backend')}}assets/img/generic/default-light.png"
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-block w-100 btn-navbar-style fs-9" for="navbar-style-dark"> <img
                            ...
                            class="img-fluid img-prototype d-light-none"
                            src="{{ asset ('backend')}}assets/img/generic/vertical-lighter.png" alt="" /><span
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarShapeSlim"> <span
                            class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                ...
                                class="img-fluid img-prototype d-light-none mb-0"
                                src="{{ asset ('backend')}}assets/img/generic/top-slim-dark.png" alt="" /></span><span
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDefault"> <span
                            class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                src="{{ asset ('backend')}}assets/img/generic/top-default.png" alt="" /><img
                                class="img-fluid img-prototype d-light-none mb-0"
                                src="{{ asset ('backend')}}assets/img/generic/top-style-darker.png" alt="" /></span><span
                            class="label-text">Default</span></label>
                </div>
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs-9" for="navbarTopDarker"> <span
                            class="mb-2 rounded d-block"><img class="img-fluid img-prototype d-dark-none mb-0"
                                src="{{ asset ('backend')}}assets/img/generic/navbar-top-style-light.png" alt="" /><img
                                class="img-fluid img-prototype d-light-none mb-0"
                                src="{{ asset ('backend')}}assets/img/generic/top-style-lighter.png" alt="" /></span><span
                            class="label-text d-dark-none">Darker</span><span
                            class="label-text d-light-none">Lighter</span></label>
                </div>
            </div>
